...
public class AcSixActivity extends AppCompatActivity {
    ...
    public AcSixActivity() {
    }

    /* access modifiers changed from: protected */
    protected void onCreate(Bundle bundle) {
        super.onCreate(bundle);
        setContentView((int) R.layout.activity_ac_six);
        ...
        this.back_img.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                AcSixActivity.this.onBackPressed();
            }
        });
        this.button = (Button) findViewById(R.id.button);
        this.button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                AcSixActivity.this.startActivity(new Intent(AcSixActivity.this, AcSevenPaymentActivity.class));
            }
        });
