...
public class AcThirdActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.activity_ac_third);
        ...
        this.back_img.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                AcThirdActivity.this.onBackPressed();
            }
        });
        ...
        this.button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                AcThirdActivity.this.startActivity(new Intent(AcThirdActivity.this, AcFourthActivity.class));
            }
        });
    }
