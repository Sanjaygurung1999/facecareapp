...
public class BathRoomFittingFifthActivity extends AppCompatActivity {
    ...
    public BathRoomFittingFifthActivity() {
    }

    /* access modifiers changed from: protected */
    protected void onCreate(Bundle bundle) {
        super.onCreate(bundle);
        setContentView((int) R.layout.activity_bath_room_fitting_fifth);
        ...
        this.back_img.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                BathRoomFittingFifthActivity.this.onBackPressed();
            }
        });
        this.button = (Button) findViewById(R.id.button);
        this.button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                BathRoomFittingFifthActivity.this.startActivity(new Intent(BathRoomFittingFifthActivity.this, BathRoomFittingSixActivity.class));
            }
        });
