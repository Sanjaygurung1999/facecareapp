...
public class BathRoomFittingOneActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.activity_bath_room_fitting_one);
        ...
        this.back_img.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                BathRoomFittingOneActivity.this.onBackPressed();
            }
        });
        this.button = (Button) findViewById(R.id.button);
        this.button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                BathRoomFittingOneActivity.this.startActivity(new Intent(BathRoomFittingOneActivity.this, BathRoomFittingSecondActivity.class));
            }
        });
    }
}
