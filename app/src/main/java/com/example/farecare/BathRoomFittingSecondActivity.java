...
public class BathRoomFittingSecondActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.activity_bath_room_fitting_second);
        ...
        this.back_img.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                BathRoomFittingSecondActivity.this.onBackPressed();
            }
        });
        this.button = (Button) findViewById(R.id.button);
        this.button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                BathRoomFittingSecondActivity.this.startActivity(new Intent(BathRoomFittingSecondActivity.this, BathRoomFittingThirdActivity.class));
            }
        });
    }
}