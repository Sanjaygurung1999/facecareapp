...
public class BathRoomFittingThirdActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.activity_bath_room_fitting_third);
        ...
        this.back_img.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                BathRoomFittingThirdActivity.this.onBackPressed();
            }
        });
        this.button = (Button) findViewById(R.id.button);
        this.button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                BathRoomFittingThirdActivity.this.startActivity(new Intent(BathRoomFittingThirdActivity.this, BathRoomFittingFourthActivity.class));
            }
        });
        ...
        this.add.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                BathRoomFittingThirdActivity.this.count++;
                BathRoomFittingThirdActivity.this.number.setText(String.valueOf(BathRoomFittingThirdActivity.this.count));
            }
        });
        this.minus.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                if (BathRoomFittingThirdActivity.this.count != 1) {
                    BathRoomFittingThirdActivity.this.count--;
                    BathRoomFittingThirdActivity.this.number.setText(String.valueOf(BathRoomFittingThirdActivity.this.count));
                }
            }
