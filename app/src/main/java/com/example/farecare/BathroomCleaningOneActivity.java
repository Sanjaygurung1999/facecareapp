...
public class BathroomCleaningOneActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.activity_bathroom_cleaning_one);
        ...
        this.back_img.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                BathroomCleaningOneActivity.this.onBackPressed();
            }
        });
        ...
        this.button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                BathroomCleaningOneActivity.this.startActivity(intent);
            }
        });
    }
}
