...
public class BlocksLeakageFifthActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.activity_blocks_leakage_fifth);
        ...
        this.back_img.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                BlocksLeakageFifthActivity.this.onBackPressed();
            }
        });
        this.button = (Button) findViewById(R.id.button);
        this.button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                BlocksLeakageFifthActivity.this.startActivity(new Intent(BlocksLeakageFifthActivity.this, BlocksLeakageSixActivity.class));
            }
        });
    }
}