...
public class BlocksLeakageSecondActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.activity_blocks_leakage_second);
        ...
        this.back_img.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                BlocksLeakageSecondActivity.this.onBackPressed();
            }
        });
        this.button = (Button) findViewById(R.id.button);
        this.button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                BlocksLeakageSecondActivity.this.startActivity(new Intent(BlocksLeakageSecondActivity.this, BlocksLeakageThirdActivity.class));
            }
        });
        ...
        this.add.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                BlocksLeakageSecondActivity.this.count++;
                BlocksLeakageSecondActivity.this.number.setText(String.valueOf(BlocksLeakageSecondActivity.this.count));
            }
        });
        this.minus.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                if (BlocksLeakageSecondActivity.this.count != 1) {
                    BlocksLeakageSecondActivity.this.count--;
                    BlocksLeakageSecondActivity.this.number.setText(String.valueOf(BlocksLeakageSecondActivity.this.count));
                }
            }
        ...
        this.add1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                BlocksLeakageSecondActivity.this.count++;
                BlocksLeakageSecondActivity.this.number1.setText(String.valueOf(BlocksLeakageSecondActivity.this.count));
            }
        });
