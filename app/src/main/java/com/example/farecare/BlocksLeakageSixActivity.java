...
public class BlocksLeakageSixActivity extends AppCompatActivity {
    ...
    public BlocksLeakageSixActivity() {
    }

    /* access modifiers changed from: protected */
    protected void onCreate(Bundle bundle) {
        super.onCreate(bundle);
        setContentView((int) R.layout.activity_blocks_leakage_six);
        ...
        this.back_img.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                BlocksLeakageSixActivity.this.onBackPressed();
            }
        });
        this.button = (Button) findViewById(R.id.button);
        this.button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                BlocksLeakageSixActivity.this.startActivity(new Intent(BlocksLeakageSixActivity.this, BlocksLeakageSevenActivity.class));
            }
        });
