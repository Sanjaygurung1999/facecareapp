...
public class EventPhotographerFifthActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.activity_event_photographer_fifth);
        ...
        this.back_img.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                EventPhotographerFifthActivity.this.onBackPressed();
            }
        });
        this.button = (Button) findViewById(R.id.button);
        this.button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                EventPhotographerFifthActivity.this.startActivity(new Intent(EventPhotographerFifthActivity.this, EventPhotographerSixActivity.class));
            }
        });
    }
}
