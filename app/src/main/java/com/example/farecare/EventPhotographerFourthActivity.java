...
public class EventPhotographerFourthActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.activity_event_photographer_fourth);
        ...
        this.back_img.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                EventPhotographerFourthActivity.this.onBackPressed();
            }
        });
        this.button = (Button) findViewById(R.id.button);
        this.button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                EventPhotographerFourthActivity.this.startActivity(new Intent(EventPhotographerFourthActivity.this, EventPhotographerFifthActivity.class));
            }
        });
    }
}
