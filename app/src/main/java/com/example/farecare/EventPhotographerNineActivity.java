...
public class EventPhotographerNineActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.activity_event_photographer_nine);
        ...
        this.back_img.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                EventPhotographerNineActivity.this.onBackPressed();
            }
        });
        this.linear = (LinearLayout) findViewById(R.id.linear);
        this.linear.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                EventPhotographerNineActivity.this.startActivity(new Intent(EventPhotographerNineActivity.this, EventPhotographerTenActivity.class));
                EventPhotographerNineActivity.this.finish();
            }
        });
    }
}