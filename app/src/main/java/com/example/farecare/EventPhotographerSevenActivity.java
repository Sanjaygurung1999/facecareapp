...
public class EventPhotographerSevenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.activity_event_photographer_seven);
        ...
        this.back_img.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                EventPhotographerSevenActivity.this.onBackPressed();
            }
        });
        this.button = (Button) findViewById(R.id.button);
        this.button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                EventPhotographerSevenActivity.this.startActivity(new Intent(EventPhotographerSevenActivity.this, EventPhotographerEightActivity.class));
            }
        });
    }
}