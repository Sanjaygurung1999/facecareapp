...
public class EventPhotographerSixActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.activity_event_photographer_six);
        ...
        this.back_img.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                EventPhotographerSixActivity.this.onBackPressed();
            }
        });
        this.button = (Button) findViewById(R.id.button);
        this.button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                EventPhotographerSixActivity.this.startActivity(new Intent(EventPhotographerSixActivity.this, EventPhotographerSevenActivity.class));
            }
        });
    }
}
