...
public class FanSevenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.activity_fan_seven);
        ...
        this.back_img.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                FanSevenActivity.this.onBackPressed();
            }
        });
        ...
        this.linear.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                intent.putExtra("layout", FanSevenActivity.this.layout);
                FanSevenActivity.this.startActivity(intent);
            }
        });
    }
}