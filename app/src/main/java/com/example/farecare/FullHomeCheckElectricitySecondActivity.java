...
public class FullHomeCheckElectricitySecondActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.activity_full_home_check_electricity_second);
        ...
        this.back_img.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                FullHomeCheckElectricitySecondActivity.this.onBackPressed();
            }
        });
        ...
        this.button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                FullHomeCheckElectricitySecondActivity.this.startActivity(intent);
            }
        });
    }
}
