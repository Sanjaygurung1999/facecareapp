...
public class GeyserFourActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.activity_geyser_four);
        ...
        this.back_img.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                GeyserFourActivity.this.onBackPressed();
            }
        });
        this.button = (Button) findViewById(R.id.button);
        this.button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                GeyserFourActivity.this.startActivity(new Intent(GeyserFourActivity.this, GeyserFiveActivity.class));
            }
        });
    }
}