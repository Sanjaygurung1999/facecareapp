...
public class HomePaintingFourthActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.activity_home_painting_fourth);
        ...
        this.back_img.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                HomePaintingFourthActivity.this.onBackPressed();
            }
        });
        this.button = (Button) findViewById(R.id.button);
        this.button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                HomePaintingFourthActivity.this.startActivity(new Intent(HomePaintingFourthActivity.this, HomePaintingFifthActivity.class));
            }
        });
    }
}
