...
public class HomePaintingSecondActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.activity_home_painting_second);
        ...
        this.back_img.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                HomePaintingSecondActivity.this.onBackPressed();
            }
        });
        this.button = (Button) findViewById(R.id.button);
        this.button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                HomePaintingSecondActivity.this.startActivity(new Intent(HomePaintingSecondActivity.this, HomePaintingThreeActivity.class));
            }
        });
    }
}