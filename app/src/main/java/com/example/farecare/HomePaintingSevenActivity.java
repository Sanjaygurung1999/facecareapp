...
public class HomePaintingSevenActivity extends AppCompatActivity {
    ...
    public HomePaintingSevenActivity() {
    }

    /* access modifiers changed from: protected */
    protected void onCreate(Bundle bundle) {
        super.onCreate(bundle);
        setContentView((int) R.layout.activity_home_painting_seven);
        ...
        this.title.setText("Home Painting");
        this.search = (ImageView) findViewById(R.id.search);
        this.search.setVisibility(View.GONE);
        this.back_img = (ImageView) findViewById(R.id.back_img);
        this.back_img.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                HomePaintingSevenActivity.this.onBackPressed();
            }
        });
        this.button = (Button) findViewById(R.id.button);
        this.button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                HomePaintingSevenActivity.this.startActivity(new Intent(HomePaintingSevenActivity.this, HomePaintingEightActivity.class));
            }
        });
