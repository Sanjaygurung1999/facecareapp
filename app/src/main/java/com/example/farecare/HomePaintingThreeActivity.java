...
public class HomePaintingThreeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.activity_home_painting_three);
        ...
        this.back_img.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                HomePaintingThreeActivity.this.onBackPressed();
            }
        });
        this.button = (Button) findViewById(R.id.button);
        this.button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                HomePaintingThreeActivity.this.startActivity(new Intent(HomePaintingThreeActivity.this, HomePaintingFourthActivity.class));
            }
        });
    }
}
