...
public class MehndiArtistBrideActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.activity_mehndi_artist_bride);
        ...
        this.back_img.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                MehndiArtistBrideActivity.this.onBackPressed();
            }
        });
        this.button = (Button) findViewById(R.id.button);
        this.button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                MehndiArtistBrideActivity.this.startActivity(new Intent(MehndiArtistBrideActivity.this, MehndiArtistBrideGusestActivity.class));
            }
        });
