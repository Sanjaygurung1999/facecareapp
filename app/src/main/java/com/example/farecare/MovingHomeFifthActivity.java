...
public class MovingHomeFifthActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.activity_moving_home_fifth);
        ...
        this.back_img.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                MovingHomeFifthActivity.this.onBackPressed();
            }
        });
        this.button = (Button) findViewById(R.id.button);
        this.button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                MovingHomeFifthActivity.this.startActivity(new Intent(MovingHomeFifthActivity.this, MovingHomeSixActivity.class));
            }
        });
    }
}
