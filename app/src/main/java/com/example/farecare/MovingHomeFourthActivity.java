...
public class MovingHomeFourthActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.activity_moving_home_fourth);
        ...
        this.back_img.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                MovingHomeFourthActivity.this.onBackPressed();
            }
        });
        this.button = (Button) findViewById(R.id.button);
        this.button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                MovingHomeFourthActivity.this.startActivity(new Intent(MovingHomeFourthActivity.this, MovingHomeFifthActivity.class));
            }
        });
    }
}