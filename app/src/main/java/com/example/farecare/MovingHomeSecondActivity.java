...
public class MovingHomeSecondActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.activity_moving_home_second);
        ...
        this.back_img.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                MovingHomeSecondActivity.this.onBackPressed();
            }
        });
        this.button = (Button) findViewById(R.id.button);
        this.button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                MovingHomeSecondActivity.this.startActivity(new Intent(MovingHomeSecondActivity.this, MovingHomeThirdActivity.class));
            }
        });
    }
}
