...
public class MovingHomeSixActivity extends AppCompatActivity {
    ...
    public MovingHomeSixActivity() {
    }

    /* access modifiers changed from: protected */
    protected void onCreate(Bundle bundle) {
        super.onCreate(bundle);
        setContentView((int) R.layout.activity_moving_home_six);
        ...
        this.back_img.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                MovingHomeSixActivity.this.onBackPressed();
            }
        });
        this.button = (Button) findViewById(R.id.button);
        this.button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                MovingHomeSixActivity.this.startActivity(new Intent(MovingHomeSixActivity.this, MovingHomeSevenActivity.class));
            }
        });
