...
public class PartyDecorationFifthActivity extends AppCompatActivity {
    ...
    public PartyDecorationFifthActivity() {
    }

    /* access modifiers changed from: protected */
    protected void onCreate(Bundle bundle) {
        super.onCreate(bundle);
        setContentView((int) R.layout.activity_party_decoration_fifth);
        ...
        this.title.setText("Party Decoration");
        this.search = (ImageView) findViewById(R.id.search);
        this.search.setVisibility(View.GONE);
        this.back_img = (ImageView) findViewById(R.id.back_img);
        this.back_img.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                PartyDecorationFifthActivity.this.onBackPressed();
            }
        });
        this.button = (Button) findViewById(R.id.button);
        this.button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                PartyDecorationFifthActivity.this.startActivity(new Intent(PartyDecorationFifthActivity.this, PartyDecorationSixActivity.class));
            }
        });
