...
public class PartyDecorationFourActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.activity_party_decoration_four);
        ...
        this.back_img.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                PartyDecorationFourActivity.this.onBackPressed();
            }
        });
        this.button = (Button) findViewById(R.id.button);
        this.button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                PartyDecorationFourActivity.this.startActivity(new Intent(PartyDecorationFourActivity.this, PartyDecorationFifthActivity.class));
            }
        });
    }
}
