...
public class PartyDecorationOneActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.activity_party_decoration_one);
        ...
        this.back_img.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                PartyDecorationOneActivity.this.onBackPressed();
            }
        });
        this.button = (Button) findViewById(R.id.button);
        this.button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                PartyDecorationOneActivity.this.startActivity(new Intent(PartyDecorationOneActivity.this, PartyDecorationSecondActivity.class));
            }
        });
    }
}
