...
public class PartyDecorationSixActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.activity_party_decoration_six);
        ...
        this.back_img.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                PartyDecorationSixActivity.this.onBackPressed();
            }
        });
        this.linear = (LinearLayout) findViewById(R.id.linear);
        this.linear.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                PartyDecorationSixActivity.this.startActivity(new Intent(PartyDecorationSixActivity.this, PartyDecorationSevenActivity.class));
            }
        });
    }
}