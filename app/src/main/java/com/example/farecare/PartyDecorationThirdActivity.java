...
public class PartyDecorationThirdActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.activity_party_decoration_third);
        ...
        this.back_img.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                PartyDecorationThirdActivity.this.onBackPressed();
            }
        });
        this.button = (Button) findViewById(R.id.button);
        this.button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                PartyDecorationThirdActivity.this.startActivity(new Intent(PartyDecorationThirdActivity.this, PartyDecorationFourActivity.class));
            }
        });
    }
}
