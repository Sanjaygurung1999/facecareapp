...
public class PestControlFifthActivity extends AppCompatActivity {
    ...
    public PestControlFifthActivity() {
    }

    /* access modifiers changed from: protected */
    protected void onCreate(Bundle bundle) {
        super.onCreate(bundle);
        setContentView((int) R.layout.activity_pest_control_fifth);
        ...
        this.back_img.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                PestControlFifthActivity.this.onBackPressed();
            }
        });
        this.button = (Button) findViewById(R.id.button);
        this.button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                PestControlFifthActivity.this.startActivity(new Intent(PestControlFifthActivity.this, PestControlSixActivity.class));
            }
        });
