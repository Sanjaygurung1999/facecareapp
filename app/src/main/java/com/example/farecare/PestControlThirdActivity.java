...
public class PestControlThirdActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.activity_pest_control_third);
        ...
        this.back_img.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                PestControlThirdActivity.this.onBackPressed();
            }
        });
        this.button = (Button) findViewById(R.id.button);
        this.button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                PestControlThirdActivity.this.startActivity(new Intent(PestControlThirdActivity.this, PestControlFourthActivity.class));
            }
        });
    }
}