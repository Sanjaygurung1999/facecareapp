...
public class ToiletSanitaryWorkFifthActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.activity_toilet_sanitary_work_fifth);
        ...
        this.back_img.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ToiletSanitaryWorkFifthActivity.this.onBackPressed();
            }
        });
        this.button = (Button) findViewById(R.id.button);
        this.button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ToiletSanitaryWorkFifthActivity.this.startActivity(new Intent(ToiletSanitaryWorkFifthActivity.this, ToiletSanitaryWorkSixActivity.class));
            }
        });
    }
}
