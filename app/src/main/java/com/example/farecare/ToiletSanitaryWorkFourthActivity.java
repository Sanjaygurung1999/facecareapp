...
public class ToiletSanitaryWorkFourthActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.activity_toilet_sanitary_work_fourth);
        ...
        this.title.setText("Toilet and Sanitary Work");
        this.search = (ImageView) findViewById(R.id.search);
        this.search.setVisibility(View.GONE);
        this.back_img = (ImageView) findViewById(R.id.back_img);
        this.back_img.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ToiletSanitaryWorkFourthActivity.this.onBackPressed();
            }
        });
        this.button = (Button) findViewById(R.id.button);
        this.button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ToiletSanitaryWorkFourthActivity.this.startActivity(new Intent(ToiletSanitaryWorkFourthActivity.this, ToiletSanitaryWorkFifthActivity.class));
            }
        });
        ...
        this.add.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ToiletSanitaryWorkFourthActivity.this.count++;
                ToiletSanitaryWorkFourthActivity.this.number.setText(String.valueOf(ToiletSanitaryWorkFourthActivity.this.count));
            }
        });
        this.minus.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                if (ToiletSanitaryWorkFourthActivity.this.count != 1) {
                    ToiletSanitaryWorkFourthActivity.this.count--;
                    ToiletSanitaryWorkFourthActivity.this.number.setText(String.valueOf(ToiletSanitaryWorkFourthActivity.this.count));
                }
            }
        ...
        this.add1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ToiletSanitaryWorkFourthActivity.this.count++;
                ToiletSanitaryWorkFourthActivity.this.number1.setText(String.valueOf(ToiletSanitaryWorkFourthActivity.this.count));
            }
        });
