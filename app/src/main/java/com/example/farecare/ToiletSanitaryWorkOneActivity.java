...
public class ToiletSanitaryWorkOneActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.activity_toilet_sanitary_work_one);
        ...
        this.back_img.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ToiletSanitaryWorkOneActivity.this.onBackPressed();
            }
        });
        this.button = (Button) findViewById(R.id.button);
        this.button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ToiletSanitaryWorkOneActivity.this.startActivity(new Intent(ToiletSanitaryWorkOneActivity.this, ToiletSanitaryWorkSecondActivity.class));
            }
        });
    }
}
