...
public class ToiletSanitaryWorkSecondActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.activity_toilet_sanitary_work_second);
        ...
        this.back_img.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ToiletSanitaryWorkSecondActivity.this.onBackPressed();
            }
        });
        this.button = (Button) findViewById(R.id.button);
        this.button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ToiletSanitaryWorkSecondActivity.this.startActivity(new Intent(ToiletSanitaryWorkSecondActivity.this, ToiletSanitaryWorkThirdActivity.class));
            }
        });
    }
}
