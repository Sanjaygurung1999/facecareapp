...
public class ToiletSanitaryWorkSevenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.activity_toilet_sanitary_work_seven);
        ...
        this.back_img.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ToiletSanitaryWorkSevenActivity.this.onBackPressed();
            }
        });
        this.linear = (LinearLayout) findViewById(R.id.linear);
        this.linear.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ToiletSanitaryWorkSevenActivity.this.startActivity(new Intent(ToiletSanitaryWorkSevenActivity.this, ToiletSanitaryWorkEightActivity.class));
            }
        });
    }
}