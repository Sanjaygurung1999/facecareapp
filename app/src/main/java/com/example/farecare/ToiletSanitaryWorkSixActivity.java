...
public class ToiletSanitaryWorkSixActivity extends AppCompatActivity {
    ...
    public ToiletSanitaryWorkSixActivity() {
    }

    /* access modifiers changed from: protected */
    protected void onCreate(Bundle bundle) {
        super.onCreate(bundle);
        setContentView((int) R.layout.activity_toilet_sanitary_work_six);
        ...
        this.back_img.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ToiletSanitaryWorkSixActivity.this.onBackPressed();
            }
        });
        this.button = (Button) findViewById(R.id.button);
        this.button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ToiletSanitaryWorkSixActivity.this.startActivity(new Intent(ToiletSanitaryWorkSixActivity.this, ToiletSanitaryWorkSevenActivity.class));
            }
        });
