...
public class ToiletSanitaryWorkThirdActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.activity_toilet_sanitary_work_third);
        ...
        this.back_img.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ToiletSanitaryWorkThirdActivity.this.onBackPressed();
            }
        });
        this.button = (Button) findViewById(R.id.button);
        this.button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ToiletSanitaryWorkThirdActivity.this.startActivity(new Intent(ToiletSanitaryWorkThirdActivity.this, ToiletSanitaryWorkFourthActivity.class));
            }
        });
    }
}