...
public class WaterTankFifthActivity extends AppCompatActivity {
    ...
    public WaterTankFifthActivity() {
    }

    /* access modifiers changed from: protected */
    protected void onCreate(Bundle bundle) {
        super.onCreate(bundle);
        setContentView((int) R.layout.activity_water_tank_fifth);
        ...
        this.back_img.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                WaterTankFifthActivity.this.onBackPressed();
            }
        });
        ...
        this.button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                intent.putExtra("layout", WaterTankFifthActivity.this.layout);
                WaterTankFifthActivity.this.startActivity(intent);
            }
        });
