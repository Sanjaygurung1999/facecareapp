...
class WaterTankFourthActivity extends AppCompatActivity {
    ImageView back_img;
    Button button;
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.activity_water_tank_fourth);
        ...
        this.back_img.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                WaterTankFourthActivity.this.onBackPressed();
            }
        });
        ...
        this.button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                intent.putExtra("layout", WaterTankFourthActivity.this.layout);
                WaterTankFourthActivity.this.startActivity(intent);
            }
        });
    }
}
