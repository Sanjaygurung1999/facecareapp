...
public class WeddingPartyOneActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.activity_wedding_party_one);
        ...
        this.circleProgressView.setValue(Float.parseFloat("15"));
        ...
        this.back_img.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                WeddingPartyOneActivity.this.onBackPressed();
            }
        });
        this.button = (Button) findViewById(R.id.button);
        this.button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                WeddingPartyOneActivity.this.startActivity(new Intent(WeddingPartyOneActivity.this, WeddingPartySecondActivity.class));
            }
        });
    }
}
