...
public class WeddingPhotographerFifthActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.activity_wedding_photographer_fifth);
        ...
        this.circleProgressView.setValue(Float.parseFloat("55"));
        ...
        this.back_img.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                WeddingPhotographerFifthActivity.this.onBackPressed();
            }
        });
        this.button = (Button) findViewById(R.id.button);
        this.button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                WeddingPhotographerFifthActivity.this.startActivity(new Intent(WeddingPhotographerFifthActivity.this, WeddingPhotographerSixActivity.class));
            }
        });
