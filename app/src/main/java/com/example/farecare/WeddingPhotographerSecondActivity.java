...
public class WeddingPhotographerSecondActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.activity_wedding_photographer_second);
        ...
        this.circleProgressView.setValue(Float.parseFloat("22"));
        ...
        this.back_img.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                WeddingPhotographerSecondActivity.this.onBackPressed();
            }
        });
        this.button = (Button) findViewById(R.id.button);
        this.button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                WeddingPhotographerSecondActivity.this.startActivity(new Intent(WeddingPhotographerSecondActivity.this, WeddingPhotographerThirdActivity.class));
            }
        });
    }
}
