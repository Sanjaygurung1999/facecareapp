...
public class WeddingPhotographerSevenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.activity_wedding_photographer_seven);
        ...
        this.circleProgressView.setValue(Float.parseFloat("77"));
        ...
        this.back_img.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                WeddingPhotographerSevenActivity.this.onBackPressed();
            }
        });
        this.button = (Button) findViewById(R.id.button);
        this.button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                WeddingPhotographerSevenActivity.this.startActivity(new Intent(WeddingPhotographerSevenActivity.this, WeddingPhotographerEightActivity.class));
            }
        });
    }
}
