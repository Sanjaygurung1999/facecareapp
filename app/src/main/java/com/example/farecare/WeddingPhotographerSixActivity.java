...
public class WeddingPhotographerSixActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.activity_wedding_photographer_six);
        ...
        this.circleProgressView.setValue(Float.parseFloat("66"));
        ...
        this.back_img.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                WeddingPhotographerSixActivity.this.onBackPressed();
            }
        });
        this.button = (Button) findViewById(R.id.button);
        this.button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                WeddingPhotographerSixActivity.this.startActivity(new Intent(WeddingPhotographerSixActivity.this, WeddingPhotographerSevenActivity.class));
            }
        });
    }
}
