...
public class WeddingPhotographerThirdActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.activity_wedding_photographer_third);
        ...
        this.circleProgressView.setValue(Float.parseFloat("33"));
        ...
        this.back_img.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                WeddingPhotographerThirdActivity.this.onBackPressed();
            }
        });
        this.button = (Button) findViewById(R.id.button);
        this.button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                WeddingPhotographerThirdActivity.this.startActivity(new Intent(WeddingPhotographerThirdActivity.this, WeddingPhotographerFourthActivity.class));
            }
        });
    }
}
