...
public class CategoryRecycleAdapter extends Adapter<CategoryRecycleAdapter.MyViewHolder> {
    ...
    public CategoryRecycleAdapter(Context context2, List<HomeCategoryModelClass> list) {
        this.OfferList = list;
    ...
    public void onBindViewHolder(@NonNull MyViewHolder myViewHolder, final int i) {
        ...
        myViewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                Intent intent = new Intent(CategoryRecycleAdapter.this.context, All_Services_Activity.class);
                intent.putExtra("layout", i);
                CategoryRecycleAdapter.this.context.startActivity(intent);
            }
        });
    }
