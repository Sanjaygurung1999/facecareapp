...
public class ReviewRatingRecycleAdapter extends Adapter<ReviewRatingRecycleAdapter.MyViewHolder> {
    ...
    public ReviewRatingRecycleAdapter(Context context2, List<HomeCategoryModelClass> list) {
        this.OfferList = list;
    ...
    public void onBindViewHolder(@NonNull MyViewHolder myViewHolder, int i) {
        ...
        myViewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ReviewRatingRecycleAdapter.this.context.startActivity(new Intent(ReviewRatingRecycleAdapter.this.context, All_Services_Activity.class));
            }
        });
    }
