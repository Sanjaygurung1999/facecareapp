...
import com.example.farecare.adapter.MovingHomeRecycleAdapter;
...
public class MovingHomeFragment extends Fragment {
    ...
    private Integer[] image = {Integer.valueOf(R.drawable.packers_movers)};
    private RecyclerView recyclerView;
    private String[] title = {"Packers & Movers"};
    private View view;

    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        this.view = layoutInflater.inflate(R.layout.fragment_moving_home, viewGroup, false);
        ...
        this.bAdapter = new MovingHomeRecycleAdapter(getActivity(), this.homeCategoryModelClasses);
